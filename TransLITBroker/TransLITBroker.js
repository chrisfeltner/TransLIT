...
// Calling the Main Translation App. Change the address below to the url of your Weather app. Response is sent back to the user via the sendMessage function //
            request("https://TransLIT.mybluemix.net/translate?text=" + text, function (error, response, body) {
